...
- [ ] 2c–2f — to be planned when reached. Vault decision: **app-managed fresh vault** (plain `.md`, frontmatter UIDs). Polish/accessibility items get parked in 2e as they come up.
