...
window.HelpModal = {
  ...
  data(){ return {
    keys: [
      ...
      { k:'e  /  enter',  d:'task detail (list) · edit focused view/project (sidebar)' },
      { k:'i',            d:'new task (list) · edit query (filter)' },
      { k:'f  /  F',      d:'focus the filter builder / collapse it' },
      { k:'n',            d:'show / hide the sidebar nav' },
      { k:'  in sidebar', d:'j/k move · enter/l open · e edit · esc/h back' },
